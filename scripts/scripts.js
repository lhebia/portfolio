...
lhApp.skills = [
    ...
    { icon: `<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                width="48" height="48"
                viewBox="0 0 172 172"
                style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#000000"><path d="M87.79167,161.82692l-62.70833,-37.05525v-73.96l62.70833,-37.05525l62.70833,37.05525v73.96zM32.25,120.68667l55.54167,32.81975l55.54167,-32.81975v-65.79l-55.54167,-32.81975l-55.54167,32.81975z"></path><circle cx="24.5" cy="5.5" transform="scale(3.58333,3.58333)" r="3.5"></circle><circle cx="24.5" cy="43.5" transform="scale(3.58333,3.58333)" r="3.5"></circle><circle cx="8.5" cy="33.5" transform="scale(3.58333,3.58333)" r="3.5"></circle><circle cx="40.5" cy="33.5" transform="scale(3.58333,3.58333)" r="3.5"></circle><circle cx="8.5" cy="15.5" transform="scale(3.58333,3.58333)" r="3.5"></circle><circle cx="40.5" cy="15.5" transform="scale(3.58333,3.58333)" r="3.5"></circle><path d="M153.08,125.41667h-130.57667l65.28833,-114.7455zM34.83,118.25h105.92333l-52.96167,-93.08783z"></path></g></g></svg>`, skillName: 'GraphQL' },
];
